...
class TestFoldersNegative:
    ...
    def test_create_folder_already_exists(self, ya_api, existing_folder):
        status_code, body = parse_response(ya_api.create_folder(existing_folder))
    ...
    def test_delete_folder_not_existing(self, ya_api):
        status_code, body = parse_response(ya_api.delete_resource(FolderData.NONEXISTENT_PATH))
